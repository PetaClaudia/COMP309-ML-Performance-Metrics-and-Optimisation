...
def load_data():
    ...
    """
    df = pd.read_csv("/Users/petadouglas/Documents/Uni/COMP309/309A4/COMP309_Ass4/Template/LinearRegression/data/Part2.csv")
    return df
...
if __name__ == '__main__':
    ...
    plt.xlabel('Weight')
    plt.ylabel('Height')
    plt.scatter(color = 'blue', x = test_data_full["Weight"], y = test_data_full["Height"])
    plt.plot(test_data_full["Weight"], test_data.dot(thetas[-1]),color='red',linewidth = 1)
    plt.show()
